                ...
                <div className='about-body-left'>
                    <div className='about-intro'>
                        <p>
                            ...
                            and traveling (when there isn't a global pandemic going on).
                    ...
                    <div className='about-connect'></div>
                        ...
                        <ul>
                            ...
                            <li><div className='icon-box'><img className='icon' src={resume_icon}/><a href = {Resume}target = "_blank">Resume</a></div></li>
                        </ul>
                </div>
