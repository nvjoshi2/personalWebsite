                ...
                <body className= 'about-body'>
                    <div className='about-body-left'>
                        <div className='about-intro'>
                            <p>
                                I'm Nathan Joshi, a recent graduate of the University of Illinois
                                at Urbana-Champaign with a B.S. in Industrial Engineering and a minor in Computer Science. 
