...
import '../MomPage.css';
import MomPic from '../../mom_pic.jpg';
const MomPage = (props) => {

    return (
        <div class="wrapper">
            <div className='mom-title'>Happy Mothers Day Moma!!!</div>
            <div className='about-body-right-container'>
                <img className='picture mom-pic' src={MomPic} />
                <div className='middle'>
                    <div className='text'>B E S T  M O M</div>
                </div>
            </div>
